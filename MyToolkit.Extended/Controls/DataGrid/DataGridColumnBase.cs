...
namespace MyToolkit.Controls
{
    public abstract class DataGridColumnBase : DependencyObject
    {
        ...
        public static readonly DependencyProperty VisibilityProperty =
            DependencyProperty.Register("Visibility", typeof(Visibility), typeof(DataGridColumnBase), new PropertyMetadata(Visibility.Visible));
        ...
        public abstract DataGridCellBase CreateEditableCell(DataGrid dataGrid, object dataItem, bool setFocus);
