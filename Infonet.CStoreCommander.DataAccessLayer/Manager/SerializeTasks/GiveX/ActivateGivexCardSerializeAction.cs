...
{
    public class ActivateGivexCardSerializeAction : SerializeAction
    {
        private readonly IGiveXRestClient _givexRestClient;
        private readonly GiveXCard _giveXCardModel;
         
        public ActivateGivexCardSerializeAction(IGiveXRestClient givexRestClient,
            GiveXCard giveXCardModel) 
            : base("ActivateGivexCard")
        {
        ...
        protected async override Task<object> OnPerform()
        {
            ...
            var response = await _givexRestClient.ActivateGivexCard(content);
