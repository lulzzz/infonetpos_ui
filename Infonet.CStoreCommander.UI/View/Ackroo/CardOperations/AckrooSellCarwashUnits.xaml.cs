...
namespace Infonet.CStoreCommander.UI.View.Ackroo
{
    ...
    public sealed partial class AckrooSellCarwashUnits : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            CardNumberBox.KeyUp -= FocusOnAckrooCarwashUnits;
            CardNumberBox.KeyUp += FocusOnAckrooCarwashUnits;
        ...
        private void FocusOnAckrooCarwashUnits(object sender, KeyRoutedEventArgs e)
        {
            if(Helper.IsEnterKey(e))
            {
                AckrooCarwashUnits.Focus(FocusState.Keyboard);
            }
        }
